...
export declare type FilterIcon = boolean | React.ReactNode | FilterIconRenderFunction;
export interface Filter extends BaseFilter {
    value?: any;
    text?: React.ReactNode;
    children?: Filter[];
}
export declare type Fixed = BaseFixed;
export declare type OnCell<RecordType> = (record?: RecordType, rowIndex?: number) => OnCellReturnObject;
export declare type OnFilter<RecordType> = (filteredValue?: any, record?: RecordType) => boolean;
export declare type OnFilterDropdownVisibleChange = (visible?: boolean) => void;
export declare type OnHeaderCell<RecordType> = (record?: RecordType, columnIndex?: number) => OnHeaderCellReturnObject;
export declare type ColumnRender<RecordType> = (text: any, record: RecordType, index: number, options?: RenderOptions) => ColumnRenderReturnType;
export declare type RenderFilterDropdownItem = (itemInfo?: FilterDropdownItem) => ReactNode;
export declare type Sorter<RecordType> = BaseSorter<RecordType>;
export declare type ColumnTitle = React.ReactNode | ((ColumnTitleProps?: ColumnTitleProps) => React.ReactNode);
export declare type FilterIconRenderFunction = (filtered: boolean) => React.ReactNode;
export declare type ColumnTitleProps = {
    sorter?: React.ReactNode;
    filter?: React.ReactNode;
    selection?: React.ReactNode;
};
export declare type ColumnRenderReturnType = React.ReactNode | RenderReturnObject;
...
export declare type OnHeaderRowReturnObject = Omit<React.HTMLAttributes<HTMLTableRowElement>, 'ref' | 'style'>;
...
export declare type GetCheckboxProps<RecordType> = (record: RecordType) => CheckboxProps;
...
export declare type GetVirtualizedListRef = (ref: MutableRefObject<any>) => void;
export declare type GroupByFunction<RecordType> = BaseGroupByFn<RecordType>;
export declare type GroupBy<RecordType> = BaseGroupBy<RecordType>;
export declare type Size = ArrayElement<typeof strings.SIZES>;
...
export declare type ChangeInfoSorter<RecordType> = BaseChangeInfoSorter<RecordType>;
...
export declare type OnChange<RecordType> = (changeInfo: ChangeInfo<RecordType>) => void;
export declare type OnRow<RecordType> = (record?: RecordType, index?: number) => OnRowReturnObject;
export declare type OnGroupedRow<RecordType> = (record?: RecordType, index?: number) => OnGroupedRowReturnObject;
export declare type OnHeaderRow<RecordType> = (columns?: ColumnProps<RecordType>[], index?: number) => OnHeaderRowReturnObject;
export declare type OnExpandedRowsChange<RecordType> = (expandedRows?: IncludeGroupRecord<RecordType>[]) => void;
export declare type OnExpand<RecordType> = (expanded?: boolean, record?: IncludeGroupRecord<RecordType>, mouseEvent?: React.MouseEvent) => void;
export declare type RenderGroupSection = (groupKey?: string | number, group?: (string | number)[]) => ReactNode | {
    [x: string]: any;
    children: ReactNode;
};
export declare type RenderPagination = (paginationProps: TablePaginationProps) => ReactNode;
export declare type RowExpandable<RecordType> = (record?: RecordType) => boolean;
export declare type RowKey<RecordType> = BaseRowKeyType | ((record?: RecordType) => string);
export declare type RowSelection<RecordType> = RowSelectionProps<RecordType> | boolean;
export declare type VirtualizedOnScrollArgs = {
...
export declare type Virtualized = boolean | VirtualizedProps;
export interface TablePaginationProps extends BaseProps, PaginationProps {
    position?: PaginationPosition;
    formatPageText?: FormatPageText;
}
export declare type Resizable<RecordType> = ResizableProps<RecordType> | boolean;
...
export declare type ResizeFn<RecordType> = (column: RecordType) => RecordType;
export interface BodyScrollEvent extends React.UIEvent {
    [x: string]: any;
    currentTarget: any;
    target: any;
}
export declare type BodyScrollPosition = 'both' | 'middle' | 'left' | 'right';
