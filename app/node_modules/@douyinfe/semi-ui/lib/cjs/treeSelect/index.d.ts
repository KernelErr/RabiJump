...
export declare type RenderSelectedItemInSingle = (treeNode: TreeNodeData) => React.ReactNode;
export declare type RenderSelectedItemInMultiple = (treeNode: TreeNodeData, otherProps: {
    index: number | string;
...
export declare type OverrideCommonState = 'keyEntities' | 'treeData' | 'disabledKeys' | 'flattenNodes';
...
declare class TreeSelect extends BaseComponent<TreeSelectProps, TreeSelectState> {
     ...
     */
    renderSingleTriggerSearchItem: () => JSX.Element;
    /**
