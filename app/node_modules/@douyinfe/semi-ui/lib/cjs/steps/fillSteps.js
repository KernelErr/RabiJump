...
const Steps = props => {
  ...
  const inner = (0, _react.useMemo)(() => {
    ...
    const filteredChildren = (0, _filter.default)(_context = _react.Children.toArray(children)).call(_context, c => /*#__PURE__*/(0, _react.isValidElement)(c));
    const colStyle = direction === 'vertical' ? null : {
      width: "".concat(100 / filteredChildren.length, "%")
    };
    const content = (0, _map.default)(_react.Children).call(_react.Children, filteredChildren, (child, index) => {
      if (!child) {
        return null;
      }

      const stepNumber = initial + index;
      const childProps = (0, _assign.default)({
      ...
      return /*#__PURE__*/_react.default.createElement(_grid.Col, {
        style: colStyle
      }, /*#__PURE__*/(0, _react.cloneElement)(child, (0, _assign.default)({}, childProps)));
    });
    return content;
...
Steps.defaultProps = {
  prefixCls: _constants.stepsClasses.PREFIX,
  current: 0,
