...
class Tooltip extends _foundation.default {
  constructor(adapter) {
    ...
    this.calcPosition = function (triggerRect, wrapperRect, containerRect) {
      ...
      triggerRect = ((0, _isEmpty2.default)(triggerRect) ? _this._adapter.getTriggerBounding() : triggerRect) || (0, _assign.default)({}, defaultRect);
      containerRect = ((0, _isEmpty2.default)(containerRect) ? _this._adapter.getPopupContainerRect() : containerRect) || (0, _assign.default)({}, defaultRect);
      wrapperRect = ((0, _isEmpty2.default)(wrapperRect) ? _this._adapter.getWrapperBounding() : wrapperRect) || (0, _assign.default)({}, defaultRect); // console.log('containerRect: ', containerRect, 'triggerRect: ', triggerRect, 'wrapperRect: ', wrapperRect);
      ...
      if (shouldUpdatePos && _this._mounted) {
        ...
        _this._adapter.setPosition((0, _assign.default)((0, _assign.default)({}, style), {
          position
        }));
      }
  ...
  calcTransformOrigin(position, triggerRect, translateX, translateY) {
    ...
    if (position && triggerRect && translateX != null && translateY != null) {
      ...
      if (this.getProp('transformFromCenter')) {
        ...
        if ((0, _includes.default)(_context = ['topLeft', 'bottomLeft']).call(_context, position)) {
          var _context2;

          return (0, _concat.default)(_context2 = "".concat(this._roundPixel(triggerRect.width / 2), "px ")).call(_context2, -translateY * 100, "%");
        }

        if ((0, _includes.default)(_context3 = ['topRight', 'bottomRight']).call(_context3, position)) {
          var _context4;

          return (0, _concat.default)(_context4 = "calc(100% - ".concat(this._roundPixel(triggerRect.width / 2), "px) ")).call(_context4, -translateY * 100, "%");
        }

        if ((0, _includes.default)(_context5 = ['leftTop', 'rightTop']).call(_context5, position)) {
          var _context6;

          return (0, _concat.default)(_context6 = "".concat(-translateX * 100, "% ")).call(_context6, this._roundPixel(triggerRect.height / 2), "px");
        }

        if ((0, _includes.default)(_context7 = ['leftBottom', 'rightBottom']).call(_context7, position)) {
          var _context8;

          return (0, _concat.default)(_context8 = "".concat(-translateX * 100, "% calc(100% - ")).call(_context8, this._roundPixel(triggerRect.height / 2), "px)");
        }
      }

      return (0, _concat.default)(_context9 = "".concat(-translateX * 100, "% ")).call(_context9, -translateY * 100, "%");
    }
  ...
  calcPosStyle(triggerRect, wrapperRect, containerRect, position, spacing) {
    triggerRect = ((0, _isEmpty2.default)(triggerRect) ? triggerRect : this._adapter.getTriggerBounding()) || (0, _assign.default)({}, defaultRect);
    containerRect = ((0, _isEmpty2.default)(containerRect) ? containerRect : this._adapter.getPopupContainerRect()) || (0, _assign.default)({}, defaultRect);
    wrapperRect = ((0, _isEmpty2.default)(wrapperRect) ? wrapperRect : this._adapter.getWrapperBounding()) || (0, _assign.default)({}, defaultRect); // eslint-disable-next-line
    ...
    if (this.getProp('showArrow') && !arrowPointAtCenter && triggerHeight <= (verticalArrowHeight / 2 + arrowOffsetY) * 2) {
      ...
      if (((0, _includes.default)(position).call(position, 'Top') || (0, _includes.default)(position).call(position, 'Bottom')) && !(0, _includes.default)(position).call(position, 'Over')) {
        top = (0, _includes.default)(position).call(position, 'Top') ? top + offsetY : top - offsetY;
      }
    ...
    if (translateX != null) {
      ...
      (0, _defineProperty.default)(style, 'translateX', {
        enumerable: false,
        value: translateX
      });
    } // eslint-disable-next-line
    ...
    if (translateY != null) {
      ...
      (0, _defineProperty.default)(style, 'translateY', {
        enumerable: false,
        value: translateY
      });
    } // eslint-disable-next-line
  ...
  isLR() {
    let position = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    return (0, _indexOf.default)(position).call(position, 'left') === 0 || (0, _indexOf.default)(position).call(position, 'right') === 0;
  }

  isTB() {
    let position = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    return (0, _indexOf.default)(position).call(position, 'top') === 0 || (0, _indexOf.default)(position).call(position, 'bottom') === 0;
