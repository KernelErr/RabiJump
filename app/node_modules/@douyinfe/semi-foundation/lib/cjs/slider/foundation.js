...
class SliderFoundation extends _foundation.default {
  constructor(adapter) {
    ...
    super((0, _assign.default)((0, _assign.default)({}, SliderFoundation.defaultAdapter), adapter));
    _this = this;
    ...
    this.outPutValue = inputValue => {
      ...
      if ((0, _isArray.default)(inputValue)) {
    ...
    this.handleValueChange = (prevValue, nextValue) => {
      ...
      if (this.valueFormatIsCorrect(nextValue)) {
        if ((0, _isArray.default)(prevValue) && (0, _isArray.default)(nextValue)) {
          ...
          resultState = (0, _assign.default)(disableState, {
    ...
    this.checkWhichHandle = pagePos => {
      ...
      if ((0, _isArray.default)(currentPos)) {
        // Slide on both sides
