...
const cssClasses = {
  PREFIX: "".concat(_constants.BASE_CLASS_PREFIX, "-table"),
  TABLE: "".concat(_constants.BASE_CLASS_PREFIX, "-table"),
  WRAP: "".concat(_constants.BASE_CLASS_PREFIX, "-table-wrapper"),
  THEAD: "".concat(_constants.BASE_CLASS_PREFIX, "-table-thead"),
  TR: "".concat(_constants.BASE_CLASS_PREFIX, "-table-row"),
  TH: "".concat(_constants.BASE_CLASS_PREFIX, "-table-row-head"),
  TD: "".concat(_constants.BASE_CLASS_PREFIX, "-table-row-cell")
};
