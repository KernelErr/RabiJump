...
const findChunks = _ref => {
  ...
  return (0, _reduce.default)(_context = (0, _filter.default)(searchWords).call(searchWords, searchWord => searchWord) // Remove empty words
...
const combineChunks = _ref2 => {
  ...
  chunks = (0, _reduce.default)(_context2 = (0, _sort.default)(chunks).call(chunks, (first, second) => first.start - second.start)).call(_context2, (processedChunks, nextChunk) => {
...
const fillInChunks = _ref3 => {
  ...
  if (chunksToHighlight.length === 0) {
    ...
    let lastIndex = 0;
    (0, _forEach.default)(chunksToHighlight).call(chunksToHighlight, chunk => {
