...
export declare type Motion<P extends Record<string, any> = any> = boolean | MotionObject | MotionFunction<P>;
export declare type MotionFunction<P> = (props: P) => MotionObject;
